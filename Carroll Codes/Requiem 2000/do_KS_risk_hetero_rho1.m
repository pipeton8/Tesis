(*
Solves for behavior of economy with idiosycratic shocks, heterogeneous preferences, and log utility
*)

ProblemToSolveString = "KS_risk_hetero_rho1";
...
dirparams; Get["params_KS_risk_hetero_rho1.m"]; dirprog;
...
dirparams; Get["params_KS_risk_hetero_fine_rho1.m"]; dirprog;
<<construct_grids_list.m;
MakeArgArrays[FunctionList];           
MakeArgArrays[ArgsForMatrices];
<<setup_list.m;
...
dirparams; Get["params_KS_risk_hetero_superfine_rho1.m"]; dirprog;
<<construct_grids_list.m;
MakeArgArrays[FunctionList];           
MakeArgArrays[ArgsForMatrices];
<<setup_list.m;
...
dirout;
ResultsFile = OpenWrite["KS_risk_hetero_rho1_results.m"];
