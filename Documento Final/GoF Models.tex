...
The random variables $y$ and $\alpha$ are distributed according to the CDFs $F_{y}$ and $F_{\alpha}$, respectively. The joint distribution of $(y,\alpha)$ will be called $F$, with support $S := (0,\infty) \times (0,1)$. Observe that in principle $y$ and $\alpha$ could be correlated. \rojo{I want to assume $y$ has Log-normal distribution but I don't know how to do this smoothly.}
